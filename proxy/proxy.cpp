...
int main () {
#ifdef _WIN32
    SetConsoleTitleA("Glittery Proxy v1");
    SetConsoleCtrlHandler(exit_handler, true); //auto hosts file

#endif


    system("color E");
    printf("Glittery Proxy\n");
    ...
    if (g_server->start()) {
        ...
        printf("Glittery is working now, you can login to the growtopia\n");
        while (true) {
            g_server->poll();
